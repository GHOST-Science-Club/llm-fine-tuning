...
The TPU port follows the changes validated in the `trl_on_tpu_working.py` showcase notebook (repo root); the full list of differences — and how to smoke-test the TPU pipeline for free, without the grant — is in [`tpu/README.md`](tpu/README.md).
